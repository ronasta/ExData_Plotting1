...
```{r getData, results='hold', purl=TRUE, cache=FALSE}
...
```{r plot1, results='hide', purl=TRUE, fig.width=5, fig.height=5}
...
```{r plot2, results='hide', purl=TRUE, fig.width=5, fig.height=5}
...
```{r plot3, results='hide', purl=TRUE, fig.width=5, fig.height=5}
...
```{r plot4, results='hide', purl=TRUE, fig.width=5, fig.height=5}
